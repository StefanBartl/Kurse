...
/*
! Project Tic-Tac-Toe Main-Javascript-File
? powered by
! Stefan Bartl
...
document.getElementById("KIInput").addEventListener("change", ()=>{
  ...
  document.getElementById("TwoNameInput").value = newName;
    ...
    document.getElementById("TwoNameInput").value = "Player 2";
  };
});
...
function StartGame(){
  ...
  // Add return Button to Gameboard Display
  const return_button = document.createElement('button');
  return_button.classList.add('returnBtn');
  return_button.innerText = "...back";
  return_button.title = "Back to the Home-Screen"
  return_button.addEventListener('click', ()=>{
    document.location.reload();
  });
  document.body.appendChild(return_button);
  return_button.classList.add("ClassHidden");
...
function winDisplay(winner, loser){
  ...
  if(winner === PlayerOneName){
    document.querySelector('.returnBtn').classList.add("ClassHidden");
...
function Countdown(isKIgame){
  ...
  countdown3.setAttribute("src", "./graphics/Icons/Countdown/3fingers.svg");
  countdown3.classList.add("Countdown");
  countdown2.setAttribute("src", "./graphics/Icons/Countdown/2fingers.svg");
  countdown2.classList.add("Countdown");
  countdown1.setAttribute("src", "./graphics/Icons/Countdown/1finger.svg");
  countdown1.classList.add("Countdown");
  go.setAttribute("src", "./graphics/Icons/Countdown/go.svg");
    ...
    const two  = setTimeout(function(){
      ...
      const one = setTimeout(function(){
        ...
        const start = setTimeout(function(){
          ...
          document.querySelector('.returnBtn').classList.remove("ClassHidden");
